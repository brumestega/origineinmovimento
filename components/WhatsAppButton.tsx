...
/**
 * Pulsante WhatsApp fisso. Il numero è quello ufficiale (347 9005251);
 * il link wa.me verrà confermato in Fase 4.
 */
export default function WhatsAppButton() {
  const message = encodeURIComponent(
    "Ciao Silvia, ho visto il sito Origine in Movimento e vorrei qualche informazione."
  );
