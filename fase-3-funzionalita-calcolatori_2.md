...
- **Pacchetto Premium — 88€**: include il PDF completo + 1 ora di lettura dal vivo con Silvia. Dopo il pagamento, l'utente viene indirizzato al sistema di prenotazione (Fase 3a) per fissare la sessione — aggiungi un nuovo tipo di prenotazione "Lettura Mappa dei Talenti" (60 minuti) accanto a "Call conoscitiva" e "Sessione" già esistenti
